...
def create_affirmation_image_from_template(affirmation_text: str, target_date: str, output_path: str = None, template_path: str = TEMPLATE_PATH) -> str:
    ...
    if output_path is None:
        output_path = f"affirmation_realtor_{target_date}.png"
...
"""
        try:
            ...
            body = {
                'snippet': {
                    ...
                    'tags': ['affirmation', 'dailyaffirmation', 'creativedaily', 'StupidOrangeRealtor', 'DubaiRealEstate'],
                    'categoryId': '22'
                },
    ...
    def process_date(self, target_date: str, post_to_youtube: bool = True, audio_file: str = None) -> dict:
        print("="*60)
        print("✨ CREATIVE DAILY - AFFIRMATION FOR REALTOR CHANNEL")
        print("="*60)
        ...
        image_path = create_affirmation_image_from_template(
            ...
            os.path.join(self.output_dir, f"affirmation_realtor_{target_date}.png")
        )
