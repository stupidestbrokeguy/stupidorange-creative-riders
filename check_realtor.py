"""
Creative Daily - Realtor Channel Version
Extracts from PDF, creates sliding animation video, uploads to YouTube
Branded for real estate / property audience.
"""
...
# ========== CONFIGURATION (REALTOR) ==========
PLAYLIST_TITLE = "Creative Daily | Stupid Orange Realtor"
PLAYLIST_DESCRIPTION = """Welcome to the Official Playlist of the Creative Daily from Stupid Orange Realtor. Here you will keep up to date with messages to help property professionals and real estate investors start collecting royalties from their creativity and live a true royal lifestyle.

#DubaiRealEstate #PropertyInvestment #CreativeDaily #StupidOrangeRealtor #UAE"""
...
def create_sliding_animation_video(image_path: str, text_content: str = None,
    ...
    try:
        ...
        if not audio_added:
            common_audio = ["background_music.mp3", "audio.mp3", "music.mp3", "bgm.mp3", "ambient.mp3", "soundtrack.mp3"]
...
class CompleteCalendarExtractor:
    ...
    def upload_to_youtube(self, video_path: str, target_date: str, page_text: str = "", video_title: str = "") -> dict:
        ...
        if video_title and video_title != "Creative Daily":
            ...
            main_title = f"Creative Daily | {formatted_date} | Stupid Orange Realtor"
        full_title = f"{main_title} | {formatted_date} | Creative Daily | Stupid Orange Realtor | #creativedaily #stupidestbrokeguy #DubaiRealEstate #PropertyInvestment"
        print(f"   📝 Title: {full_title[:80]}...")
        video_description = f"""{page_text[:4500] if page_text else ''}
        
- Help someone collect their first royalty from creativity : join Stupid Orange Realtor Waiting List - www.stupidorange.com |
- Secure a copy of the latest Creative Daily and get daily messages that will fasttrack you to collecting your first royalty - creativedaily.stupidorange.com |
- Have you successfully finished today's Creative Daily Assignment? Share your screenshots and comment #creativedaily |

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✨ {main_title} | {formatted_date} | Creative Daily | Stupid Orange Realtor
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#creativedaily #stupidestbrokeguy #DubaiRealEstate #PropertyInvestment #UAE #realestateagent
"""
        ...
        try:
            ...
            body = {
                'snippet': {
                    ...
                    'tags': ['creativedaily', 'DubaiRealEstate', 'PropertyInvestment', 'StupidOrangeRealtor', target_date],
                    'categoryId': '22'
                },
    ...
    def process_date(self, target_date: str, post_to_youtube: bool = True,
        ...
        print("="*60)
        print("📅 CREATIVE DAILY - REALTOR EDITION")
        print("🎬 60% zoom | Yellow background | Auto thumbnail")
        print("="*60)
...
if __name__ == "__main__":
    print("="*60)
    print("🎬 CREATIVE DAILY REALTOR SCRIPT STARTING")
    print("="*60)
    ...
    if result['status'] == 'success':
        ...
        if result.get('youtube') and result['youtube']['status'] == 'success':
            ...
            print(f"   📁 Playlist: {PLAYLIST_TITLE}")
            print(f"   🖼️ Thumbnail: Auto-extracted")
